...
<body>
      ...
      <div class="header_bg">
         <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <a class="logo" href="home_doner.php"><img src="images/logo.png" style="height: 80px;"></a>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                     <li class="nav-item active">
                        <a class="nav-link" href="home_doner.php">Home</a>
                     </li>

                   

                     <li class="nav-item">
                        <a class="nav-link" href="doner_services.php">Services</a>
                     </li>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="banner_taital_main">
                        <div class="row">
                           <div class="col-md-6">
                              <h1 class="banner_taital" style="color: black;">Medicine Donation</h1>
                              <h2 class="banner_text" style="color: black; font-size: 20px;">We Donate. We Save.</h2>
                              <div class="btn_main">
   ...
   <div class="services_section layout_padding">
      <div class="container">
         <h1 class="services_taital"><span style="color: #fcce2d">We</span> Donate</h1>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="image_main">
                     ...
                     <div class="text_main">
                        <div class="seemore_text">Over-the-Counter (OTC) Medications</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="image_main">
                     ...
                     <div class="text_main">
                        <div class="seemore_text">Prescription Medications</div>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-6">
                  <div class="image_main">
                     ...
                     <div class="text_main">
                        <div class="seemore_text">Medications for Chronic Conditions</div>
                     </div>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="image_main">
                     ...
                     <div class="text_main">
                        <div class="seemore_text">Insulin</div>
                     </div>
                  </div>
               </div>
            </div>
