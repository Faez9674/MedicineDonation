...
$sql = "SELECT * FROM donar_request WHERE id='$id'";
...
$doner_id = $row['donar_id'];


$sql1 = "SELECT * FROM unusedmedicine WHERE donor_id='$doner_id'";
...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-7" style="text-align: right;"><h2 style="font-size: 25px;">Unused Medicine List</h2> </div>
        <div class="col-md-5" style="text-align: right;"><a href="ngo_medicine_request.php" class="btn btn-danger">Back</a></div>
    </div>
