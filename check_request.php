...
$sql = "SELECT * FROM donar_request WHERE donar_id = '$id'";
...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-7" style="text-align: right;"><h2 style="font-size: 25px;">Check Request List</h2> </div>
